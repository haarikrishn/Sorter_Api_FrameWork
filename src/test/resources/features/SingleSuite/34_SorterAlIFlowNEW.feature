Feature: verify the functionality of UpdateDeliveryInSorter in sorter
  ...
  @SorterCreateDeliveryAllFlowNew1
  Scenario: Verify the functionality of CreateOneDeliveryWithListOfItemsUsingDT
    ...
    And Provide dlvItemNum to CreateOneDeliveryWithListOfItemsUsingDTInSorter
      ...
      | 0002    | 5102747694 | 20         | 840222000149 | 92  | 200000347 | LG HING POWDER(50G)  | 2SPOSPXXX | S      | 3000  | 1C40050092 | 200            | 200     | EA  | 0.071  | KG    | 0.007   | FT3    | A          | HRS         | 21    |
...
#      | password | Dmart@123 |
  ...
  @CreateTOForOriginalDeliveryFlowNew5
  Scenario: Verify the functionality of CreateTOWithListOftransferOrderItems
    ...
    And Provide transferOrderItems to CreateTOWithListOftransferOrderItems
      ...
      | 0001          | 200000346 | LG HING POWDER(100G) | 840222000156 | 1C40050182 | HRS            | A01-24-2C     | 100.000 | 100.00  | EA  | 182.00 | 0.132      | 0.012      | ZBGR     | 191    | 20250501 | 3000       | 200             | 600       | 1               |
      | 0002          | 200000347 | LG HING POWDER(50G)  | 840222000149 | 1C40050092 | HRS            | A01-25-1B     | 200.000 | 200.00  | EA  | 92.00  | 0.071      | 0.007      | ZBGR     | 194    | 20250525 | 3000       | 200             | 1600      | 1               |
#      | 0003          | 200004280 | SAMS WHITE COOKING VINEGAR-700ML | 8906027120665 | JC40020070 | HRS            | A014-01-1B    | 24.000  | 24.00   | EA  | 70.00  | 0.750      | 0.043      | ZBGR     | 4682   | 20250910 | 3000       | 200             | 720.000   | 1               |
#      | 0004          | 200005944 | MAGGI MASALA MAGIC(72G)          | 8901058007220 | 1B40130060 | HRS            | A010-06-1B    | 60.000  | 60.00   | EA  | 60.00  | 0.100      | 0.022      | ZBGR     | 3322   | 20241031 | 3000       | 200             | 1680.000  | 1               |
#      | 0005          | 200006642 | PAAWAK NATURAL JAGGERY JAR-500G  | 8906053810264 | EC40020110 | HRS            | A018-23-1A    | 48.000  | 24.00   | EA  | 110.00 | 0.500      | 0.043      | ZBGR     | 6473   | 20250309 | 3000       | 200             | 792.000   | 2               |
